...
if( !isset($_REQUEST['color1']) ) {
  printUsage();
} else $startcolor = $_REQUEST['color1'];

if( !isset($_REQUEST['color2']) ) {
  printUsage();
} else $endcolor = $_REQUEST['color2'];
...
function printUsage() {
    ...
    exit("                                                                                                   
    Usage:                                                                                                   
            gradient.php?height=__Height__&color1=__Color1__&color2=__Color2__                          
                                                                                                             
            gradient.php :: Height -> Color -> Color -> Jpeg                                                                                                                                         
                                                                                                             
    Types:                                                                                                   
            Height :: Number
         	Color :: String (ex: 'ff0' or 'dd4578')
    ");
...
$image = new gd_gradient_fill($width,$height,$direction,$startcolor,$endcolor);
header('Content-Type: image/jpeg');
imagejpeg($image);
imagedestroy($image);
