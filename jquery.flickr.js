...
(function($) {
  ...
  $.flickr.thumbnail.process = function(photos) {
    var thumbnails = $.map(photos.photo, function(photo) {
      ...
      html = $.flickr.thumbnail.imageTag(image); 
      return ['<li>' + html + '</li>']
    }).join("\n")
  ...
  $.flickr.methods = {
	...
	groupsPoolsGetPhotos: function(options) {
	  $.flickr.photos('flickr.groups.pools.getPhotos', options)
	}
  }
  ...
  $.fn.flickr = function(options) {
    ...
    $.flickr.settings = $.extend({
      api_key: '5bc8586332ba0339327a9d0ed3b28742',
      thumbnail_size: 'sq'
    }, options || {})
